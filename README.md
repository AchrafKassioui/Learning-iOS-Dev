...
In [this Apple Developer forum thread](https://developer.apple.com/forums/thread/119112), an Apple engineer posted a code sample to set up a Metal view with SwiftUI. The code is not longer correctly formatted. I paste here for future reference:
...
That code produces this window:

<img src="Screenshots/MetalViewCodeSample.png" alt="MetalViewCodeSample" style="zoom:50%;" />

## Swift & C

*31 May 2026*

It's possible to use C directly inside Swift. Below is a tutorial on how to mix Swift and C in the same Xcode project, using [SpriteKit-Box2D](https://github.com/AchrafKassioui/SpriteKit-Box2D) as a sample app.
